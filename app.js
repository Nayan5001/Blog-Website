...
{
  res.render("home",{homeContent:homeStartingContent,publishContent:arr});
...
{
  let post={
  contentTitle:req.body.postTitle,
  contentBody:req.body.postBody
};
arr.push(post);
res.redirect("/");
});
...
{
  let requstPostName=_.lowerCase(req.params.postName);
  arr.forEach(function(element)
{
  if(_.lowerCase(element.contentTitle)===requstPostName)
  {
    res.render("post",{currentPostTitle:element.contentTitle,currentPostBody:element.contentBody});
  }
